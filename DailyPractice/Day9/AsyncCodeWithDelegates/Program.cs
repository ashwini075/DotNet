...
namespace AsyncCodeWithDelegates2
{
    class Program
    {
        ...
        {
            System.Threading.Thread.Sleep(5000);
            Console.WriteLine("Display name : " + s);
        }
    }
}
...
namespace AsyncCodeWithDelegates3
{
    class Program
    {
        static void Main1()
        {
            ...
            o.BeginInvoke("using callback function", CallxcBackFunc, null);
            Console.WriteLine("After");
            Console.ReadLine();
        }
        ...
        static void CallxcBackFunc(IAsyncResult ar)
        {
...
namespace AsyncCodeWithDelegates4
{
    class Program
    {
        static void Main1()
        {
            Console.WriteLine("Before");
            Func<string, string> o = Display;
            o.BeginInvoke(" sai ", delegate (IAsyncResult ar)
            {
                Console.WriteLine("callback func called");
